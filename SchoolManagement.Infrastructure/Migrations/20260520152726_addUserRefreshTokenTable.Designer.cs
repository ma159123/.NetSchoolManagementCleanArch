...
namespace SchoolManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260520152726_addUserRefreshTokenTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Core.Entities.identity.UserRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Core.Entities.identity.UserRefreshToken", b =>
                {
                    b.HasOne("SchoolManagement.Core.Entities.identity.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
